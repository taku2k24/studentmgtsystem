...
public class Register extends JFrame {
    ...
    private void saveStudentDetails() {
        ...
        try (Connection connection = connectionManager.getConnection()) {
            ...
            JOptionPane.showMessageDialog(this, "Error saving student details: " + e.getMessage(), "Error",
    ...
    //         @Override
    //         public void run() {
    //             StudentRegistrationFrame frame = new StudentRegistrationFrame("your_username");
